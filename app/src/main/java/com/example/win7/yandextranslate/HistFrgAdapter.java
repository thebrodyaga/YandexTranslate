...
import com.example.win7.yandextranslate.HistoryFragment.OnListFragmentInteractionListener;
 ...
 */
public class HistFrgAdapter extends RecyclerView.Adapter<HistFrgAdapter.ViewHolder> {

    private List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public HistFrgAdapter(List<DummyItem> items, HistoryFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
